        ...
        <div class="col-md-4">
            <dl class="well">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        {{ Form::open(['route'=>['article.destroy',$article->id], 'method'=>'DELETE', 'onsubmit' => 'return confirmDelete()']) }}
                        {{ Form::submit('Delete',['class'=>'btn btn-danger confirm btn-block', 'data-confirm' => 'Are you sure you
                        want to delete?']) }} {{ Form::close() }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
