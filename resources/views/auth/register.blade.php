      ...
      <form method="POST" action="{{ route('register') }}">
        {{ csrf_field() }}
            <div class="form-group{{ Session::has('username') ? ' has-error' : '' }}">
                ...
                <div>
                    <input id="username" type="text" class="form-control" name="username" value="{{ old('username') }}" required autofocus min="5">
            ...
            <div class="form-group{{ Session::has('password') ? ' has-error' : '' }}">
                ...
                <div>
                    <input id="password" type="password" class="form-control" name="password" required min="8">
            ...
            <div class="form-group">
                    <div class="row">
                            <div class="col-md-8">
                            <div class="pull-left">
                                Already have an account? <br>Sign In <a href="{{ route('login') }}">here</a>
                            </div></div>
                            <div class="col-md-4">
